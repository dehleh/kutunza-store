            ...
            {companies.length === 0 ? (
              ...
              companies.map((company) => (
                <tr key={company.id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{company._count.stores}</td>
...
function AddCompanyForm({ onClose, onSuccess }: { onClose: () => void; onSuccess: () => void }) {
